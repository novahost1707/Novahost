      ...
      <Container>
        <div className="grid grid-cols-[minmax(0,0.85fr)_minmax(0,1fr)] items-start gap-14 max-[900px]:grid-cols-1 max-[900px]:gap-10">
          <div className="reveal">
            <SectionMarker index="08" label={contact.eyebrow} />

            <h2 className="mt-3.5 text-[clamp(28px,3.8vw,46px)]">
              {contact.title}
            </h2>
            ...
            <div className="mt-9 flex flex-col gap-3">
              <a
                ...
                className="glow-hover group flex items-center justify-between gap-4 rounded-card border border-nh-line bg-nh-surface/60 px-5 py-4 hover:-translate-y-0.5 hover:border-[color-mix(in_oklab,var(--color-nh-blue)_28%,transparent)]"
              >
